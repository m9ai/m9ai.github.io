    ...
    <div className="container mx-auto py-16 px-4">
      ...
      <div id="details" className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-900">核心优势</h2>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-900">应用场景</h2>
          <ul className="space-y-4">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
          ...
          <h2 className="text-2xl font-bold mb-4 text-gray-900">技术特点</h2>
      ...
      {service.cases && service.cases.length > 0 && (
        <div className="mb-20">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">成功案例</h2>
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <div className="text-blue-600 font-medium mb-2">案例研究</div>
          <h3 className="text-2xl font-bold mb-4 text-gray-900">{service.cases[0].title}</h3>
          <p className="text-gray-700 mb-6">{service.cases[0].description}</p>
              </div>
              <div className="relative h-64 md:h-auto min-h-[300px]">
                <Image
                  src={service.imageUrl}
                  alt={service.cases[0].title}
                  fill
                  className="object-cover"
                />
              </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-3xl p-8 md:p-12 text-white text-center">
        <h2 className="text-3xl font-bold mb-4">准备好开始您的AI转型之旅了吗？</h2>
        <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
          联系我们，获取专属的AI解决方案咨询，让我们一起打造智能化未来
        </p>
        <a
          href="mailto:c@m9ai.work"
