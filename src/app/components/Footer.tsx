      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='flex space-x-6'>
            <Link href='#privacy' className='text-sm hover:text-emerald-400 transition-colors'>隐私政策</Link>
            <Link href='#terms' className='text-sm hover:text-emerald-400 transition-colors'>服务条款</Link>
