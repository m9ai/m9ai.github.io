                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 transition-all duration-300 hover:shadow-md">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex items-center gap-2 text-slate-700 dark:text-slate-300 mb-2">
                      ...
                      <span>扫码添加服务顾问微信</span>
                    </div>
                  </div>
                </div>

                <div className="space-y-4">
                  <a href="mailto:justin@m9ai.dev" className="flex items-center gap-3 p-4 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700 transition-all duration-300 hover:shadow-md">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-slate-900 dark:text-white">justin@m9ai.dev</p>
                    </div>
                  </a>
                </div>
